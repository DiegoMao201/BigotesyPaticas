...
down_revision: str | None = "0003_suppliers"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "total_products_counted", sa.Integer, nullable=False, server_default=sa.text("0")
        ),
    ...
    op.create_table(
        ...
        sa.Column("value_impact", sa.Numeric(16, 2), nullable=True),
