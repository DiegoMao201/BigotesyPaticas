...
CATEGORIES = [
    {"name": "Perros", "slug": "perros", "sort_order": 1,
     "description": "Alimento, accesorios y cuidado para perros."},
    {"name": "Gatos", "slug": "gatos", "sort_order": 2,
     "description": "Alimento, accesorios y cuidado para gatos."},
    {"name": "Accesorios", "slug": "accesorios", "sort_order": 3,
...
PRODUCTS = [
    # Perros
    {"sku": "RC-MA-2KG", "slug": "royal-canin-mini-adulto-2kg",
     ...
     "brand_slug": "royal-canin", "category_slug": "perros",
     "price": Decimal("89000"), "compare_at_price": Decimal("99000"), "cost": Decimal("65000"),
     "is_featured": True,
     "tags": ["perro", "adulto", "raza-pequena", "premium"]},
    {"sku": "PP-AD-7KG", "slug": "pro-plan-adulto-7kg",
     ...
     "brand_slug": "pro-plan", "category_slug": "perros",
     "price": Decimal("215000"), "cost": Decimal("160000"),
     "is_featured": True,
     "tags": ["perro", "adulto", "raza-mediana"]},
    # Gatos
    {"sku": "HSD-GAT-1.5KG", "slug": "hills-gato-adulto-1-5kg",
     ...
     "brand_slug": "hills", "category_slug": "gatos",
     "price": Decimal("78000"), "cost": Decimal("58000"),
     "is_featured": True,
     "tags": ["gato", "adulto"]},
    {"sku": "RC-INDOOR", "slug": "royal-canin-indoor-cat-1-5kg",
     ...
     "brand_slug": "royal-canin", "category_slug": "gatos",
     "price": Decimal("82000"), "cost": Decimal("60000"),
     "tags": ["gato", "indoor"]},
    # Accesorios
    {"sku": "BP-COL-001", "slug": "collar-cuero-premium-mediano",
     ...
     "brand_slug": "bp", "category_slug": "accesorios",
     "price": Decimal("45000"), "cost": Decimal("18000"),
     "is_featured": True,
     "tags": ["accesorio", "collar", "cuero"]},
    {"sku": "BP-COR-001", "slug": "correa-retractil-5m",
     ...
     "brand_slug": "bp", "category_slug": "accesorios",
     "price": Decimal("65000"), "cost": Decimal("30000"),
     "tags": ["accesorio", "correa"]},
    # Snacks
    {"sku": "BP-SNK-001", "slug": "snack-natural-pollo-200g",
     ...
     "brand_slug": "bp", "category_slug": "snacks",
     "price": Decimal("18000"), "cost": Decimal("8000"),
     "is_featured": True,
     "tags": ["snack", "natural", "pollo"]},
    {"sku": "BP-SNK-002", "slug": "galletas-dentales-300g",
     ...
     "brand_slug": "bp", "category_slug": "snacks",
     "price": Decimal("22000"), "cost": Decimal("9000"),
     "tags": ["snack", "dental"]},
]
...
async def seed_catalog() -> None:
    async with AsyncSessionLocal() as db:
        ...
        for b in BRANDS:
            ...
            if existing is None:
                brand = Brand(name=b["name"], slug=b["slug"], is_active=True,
