...
_EDUCATIONAL_TOPICS = [
    {"key_data": "38%",    "topic": "de perros en Colombia presentan sobrepeso, según estudios nutricionales regionales"},
    {"key_data": "72 h",   "topic": "es el tiempo máximo sin agua que tolera un gato adulto antes de sufrir daño renal irreversible"},
    {"key_data": "2 kg",   "topic": "de sobrepeso equivalen a 20 kg de presión extra en las articulaciones de un perro mediano"},
    {"key_data": "3×",     "topic": "más riesgo de diabetes tienen los gatos castrados sin ajuste en su dieta calórica"},
    {"key_data": "6 min",  "topic": "es el tiempo que tarda el calor en ser letal para un perro dentro de un carro con ventanas cerradas"},
    {"key_data": "80%",    "topic": "de perros mayores de 3 años presentan algún grado de enfermedad periodontal"},
    {"key_data": "1 de 4", "topic": "gatos domésticos en Colombia desarrolla cálculos urinarios vinculados a dieta seca y poca hidratación"},
    {"key_data": "17%",    "topic": "de gatos domésticos en Latinoamérica son alimentados con croquetas inadecuadas para su etapa de vida"},
]
